...
struct NewService: NewMethodProtocol {
...
extension Person: Job1 {
    func doWork() {
        print("\(self.name!)님이 일을 합니다")
    }
}
let person = Person(name: "장석진")
person.doWork()
