...
class People {
    ...
    var job: Job = .programmer
}
class UniversityStudent: People {
    enum School {
        case elementarySchool, middle, high, university
    }
...
let peopleJob: People.Job = .student
let studentJob: UniversityStudent.Job = .programmer
...
struct Esports {
    ...
    var gameInfo: GameInfo {
        switch self.gameType {
        case .online:
            return GameInfo(location: "www.baramonline.com", pakage: "Country of Baram")
        case .offline:
            return GameInfo(location: "Incheon", pakage: "LOL")
        }
    }
}
...
var baram = Esports(gameType: .online)
print(baram.gameInfo)

//about swift patterns
print("---------------------------Patterns------------------")
...
var reference1: StrongReference?
var reference2: StrongReference?
var reference3: StrongReference?

reference1 = StrongReference(name: "Jin") //참조 카운트 +1.  ---> 1
reference2 = reference1 //참조카운트 +1 ---> 2
reference3 = reference1 //참조카운트 +1 ---> 3

reference3 = nil //참조카운트 -1 ---> 2
reference2 = nil //참조카운트 -1 ---> 1
reference1 = nil //참조카운트 -1 ---> 0 , 여기서 deinit 구문 프린트 실행됨
